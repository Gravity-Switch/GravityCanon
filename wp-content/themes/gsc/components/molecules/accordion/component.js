...
Array.prototype.slice.call(document.querySelectorAll(".js-accordion")).forEach(function (accordion) {
  ...
  var triggers = Array.prototype.slice.call(accordion.querySelectorAll(".js-accordion__btn"));
  var panels = Array.prototype.slice.call(accordion.querySelectorAll(".js-accordion__section"));

  accordion.addEventListener("click", function (event) {
    var target = event.target;

    if (target.classList.contains("js-accordion__btn")) {
  ...
  accordion.querySelectorAll(".js-accordion__btn").forEach(function (trigger) {
